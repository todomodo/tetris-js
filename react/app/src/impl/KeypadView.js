...
export default class KeypadView extends React.Component {
    ...
    statusText() {
        switch (this.props.tracker.status) {
        ...
        return (
            <div className='KeypadView'>
                <table>
                    <tbody>
                    <tr>
                        <td colSpan="3" bgcolor={this.statusColor()}>{this.statusText()}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className='boxed'>{this.props.tracker.score}</td>
                    </tr>
                    <tr>
                        <td className='boxed' colSpan="2">Level</td>
                        <td className='boxed'>{this.props.tracker.speed}</td>
                    </tr>
                    <tr>
                        <td className='spacer' colSpan="3"></td>
                    </tr>
